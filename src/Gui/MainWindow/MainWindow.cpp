...
const char COMMUNITY_FORUM_URL[] = "https://cryptoricochet.herokuapp.com";
const char REPORT_ISSUE_URL[] = "https://cryptoricochet.cl";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Ricochet Wallet %1").arg(Settings::instance().getVersion()));
